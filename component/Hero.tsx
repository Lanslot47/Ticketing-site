...
const Hero = () => {
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center md:justify-between min-h-screen px-4 sm:px-8 text-white gap-10">
        <motion.div
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <img
              ...
              alt="Movie Poster"
              className="rounded-2xl shadow-2xl w-[220px] sm:w-[280px] md:w-[410px] h-[330px] sm:h-[420px] md:h-[500px] object-cover"
            />
          </motion.div>
        </AnimatePresence>
      </div>
